...
public class Canvas
{
    ...
    public static Canvas getCanvas()
    {
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("BlueJ Picture Demo", 100000, 100000, 
                                         Color.white);
        }
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red")) {
            ...
            graphic.setColor(new Color(153, 0, 204));
        }
        else if(colorString.equals("cyan")) {
            graphic.setColor(new Color(0, 255, 255));
        }
        else if(colorString.equals("orange")) {
            graphic.setColor(new Color(255, 102, 0));
        }
        else if(colorString.equals("brown")) {
            graphic.setColor(new Color(153, 51, 0));
        }
